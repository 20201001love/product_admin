<template>
  <div class="app-container">
    ...
    <!-- 表格 -->
    <el-table @row-click="clickRow" ref="table" highlight-current-row border v-loading="loading" :data="customerList"
...
import { listCustomer, getCustomer, delCustomer, addCustomer, updateCustomer } from "@/api/demand/customer"
...
/** 导出按钮操作 */
const handleExport = () => {
  proxy.download('demand/customer/export', {
    ...queryParams.value
